...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        amberc: {
            ...
            all: {
                src: [
                    'src/Hschart.st', // list all sources in dependency order
                    'src/Hschart-Tests.st' // list all tests in dependency order
                ],
                amd_namespace: 'amber-hschart',
                libraries: ['SUnit', 'Web']
            },
            test_runner: {
                ...
                libraries: [
                    ...
                    'Hschart', /* add other code-to-test packages here */
                    'SUnit',
                    'Hschart-Tests' /* add other test packages here */
                ],
